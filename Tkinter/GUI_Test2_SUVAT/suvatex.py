...
def suvatSolver():
    ...
    s = input("Do you know distance? If so, what is it (in metres)? If not, write 'n'.")
    ...
    u = input("Do you know initial velocity? If so, what is it (in metres/second)? If not, write 'n'.")
    if u != "n":
        uKnown = True
        u = float(u)
        variableCount += 1
    ...
    while variableCount < 1:
        v = input("Do you know final velocity? If so, what is it (in metres/second)? If not, write 'n'.")
        if v != "n":
            vKnown = True
            v = float(v)
            variableCount += 1
    ...
    while variableCount < 2:
        a = input("Do you know acceleration? If so, what is it (in metres/second^2)? If not, write 'n'.")
        if a != "n":
            aKnown = True
            a = float(a)
            variableCount += 1
    ...
    while variableCount < 3:
        t = input("Do you know time? If so, what is it (in seconds)? If not, write 'n'.")
        if t != "n":
            tKnown = True
            t = float(t)
            variableCount += 1
